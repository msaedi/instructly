    ...
    <div className="min-h-screen insta-onboarding-page">
      ...
      <div className="container mx-auto px-8 lg:px-32 py-8 max-w-6xl">
        ...
        <div className="insta-surface-card insta-onboarding-header">
          <div>
            <h1 className="insta-onboarding-title">Get Paid for Your Lessons</h1>
            <p className="insta-onboarding-subtitle">Connect your bank securely through Stripe{skillsSkipped ? ' • You can add skills later' : ''}</p>
          </div>
        </div>
        {/* Divider */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="insta-onboarding-benefit-card">
                    <div className="flex items-start gap-3">
                      <div className="insta-onboarding-benefit-icon w-8 h-8 flex items-center justify-center flex-shrink-0">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                      </div>
                      <div>
                        <p className="insta-onboarding-benefit-title">Quick Setup</p>
                        <p className="insta-onboarding-benefit-copy">Usually takes just a few minutes</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="insta-onboarding-benefit-card">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="insta-onboarding-benefit-title">Direct Deposits</p>
                        <p className="insta-onboarding-benefit-copy">Payments go straight to you</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="insta-onboarding-benefit-card">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="insta-onboarding-benefit-title">Bank Security</p>
                        <p className="insta-onboarding-benefit-copy">Protected by Stripe&apos;s encryption</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="mt-6 sm:mt-8 flex items-end justify-end">
                    <div className="text-right">
                      <button
                        ...
                        className="insta-primary-btn inline-flex items-center justify-center w-full sm:w-auto px-4 py-2 rounded-lg sm:rounded-md text-base sm:text-sm h-auto sm:h-10 text-white disabled:opacity-50 shadow-sm whitespace-nowrap"
                      >
                        {connectLoading ? (
                          <>
      ...
      <div className="mt-4 sm:mt-8 flex items-center justify-end gap-3">
        ...
        <button
          onClick={() => { window.location.href = '/instructor/onboarding/status'; }}
          className="insta-primary-btn w-40 px-5 py-2.5 rounded-lg text-white disabled:opacity-50 shadow-sm justify-center"
        >
          Continue
        </button>
      </div>

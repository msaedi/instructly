          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 ring-1 ring-gray-300 dark:ring-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700"
              >
              ...
              <button
                type="button"
                onClick={() => void logout()}
                className="inline-flex items-center rounded-full px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 ring-1 ring-gray-300 dark:ring-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                Log out
              </button>
            </div>
              ...
              <BookingsTab
                ...
                bulkActions={(
                  <div className="flex items-center justify-between text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <button
                      type="button"
                      className="rounded-full px-4 py-2 text-xs font-medium ring-1 ring-gray-300 dark:ring-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700"
                    >
                      Bulk Actions
                    </button>
                  </div>

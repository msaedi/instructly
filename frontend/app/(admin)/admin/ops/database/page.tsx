...
import DatabasePoolStatus from '@/app/(admin)/admin/ops/database/components/DatabasePoolStatus';
import AdminSidebar from '@/app/(admin)/admin/AdminSidebar';
import { useAuth } from '@/features/shared/hooks/useAuth';

export default function DatabaseOpsPage() {
  ...
  useEffect(() => {
    if (!authLoading && !isAdmin) {
      router.push(`/login?redirect=${encodeURIComponent('/admin/ops/database')}`);
    }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-semibold">Database Health</h1>
            </div>
          ...
          <div className="col-span-12 md:col-span-9 lg:col-span-9">
            ...
            <div className="rounded-2xl shadow-sm ring-1 ring-gray-200/70 dark:ring-gray-700/60 bg-white/60 dark:bg-gray-900/40 backdrop-blur">
              <div className="p-6 border-b border-gray-200/70 dark:border-gray-700/60">
                <h3 className="text-lg font-semibold flex items-center gap-2"><Database className="h-5 w-5" />Connection Pool Status</h3>
              </div>
              <div className="p-6">
                {loading ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-600 dark:text-red-400 mt-1">
                      Database connection pool is at {data.pool.usage_percent}% capacity. Deploy the increased pool size configuration immediately.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
              <Database className="inline-block h-4 w-4 mr-1" />Auto-refreshing every 30 seconds
            </div>
          </div>
        </div>
      </main>

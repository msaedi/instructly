        ...
        <nav className="bg-white dark:bg-gray-800 shadow-sm border-b">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              <Link href="/" className="text-3xl font-bold text-(--color-brand) hover:text-purple-900 dark:hover:text-purple-300 transition-colors">
                iNSTAiNSTRU
              </Link>
              <UserProfileDropdown />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 text-center">
            ...
            <Link
              ...
              className="inline-block px-6 py-2 bg-(--color-brand) text-white rounded-md hover:bg-purple-800 dark:hover:bg-purple-700 transition-colors font-semibold"
        ...
        <div className="flex items-center justify-between max-w-full">
          <div className="flex items-center gap-4">
            <Link className="inline-block" href="/">
              <span className="text-3xl font-bold text-(--color-brand) hover:text-purple-900 dark:hover:text-purple-300 transition-colors cursor-pointer pl-4">
                {BRAND.name}
              </span>
            </Link>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 space-y-4">
            ...
            <ChecklistRow
              ...
              ok={false}
              action={
                <Link href="/instructor/onboarding/verification" className="text-(--color-brand) hover:underline">
                  Start verification
                </Link>
              }
            />
            ...
            <ChecklistRow
              ...
              action={
                <Link href="/instructor/onboarding/skill-selection?redirect=%2Fdashboard%2Finstructor" className="text-(--color-brand) hover:underline">
                  Edit skills
                </Link>
              }
            />
            <div className="pt-2">
              <button
                className="px-5 py-2.5 rounded-lg text-white bg-(--color-brand) hover:bg-purple-800 dark:hover:bg-purple-700 disabled:opacity-50 font-semibold"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            ...
            <p className="text-3xl font-bold text-(--color-brand)">0</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-3xl font-bold text-(--color-brand)">{formattedRating}</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          >
            <div className="flex items-center gap-4">
              <Calendar className="w-8 h-8 text-(--color-brand)" />
              <div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 mb-8">
          <div className="flex justify-between items-start mb-6">
            ...
            <button
              ...
              className="flex items-center px-4 py-2 bg-(--color-brand) text-white rounded-md hover:bg-purple-800 dark:hover:bg-purple-700 transition-colors font-semibold"
            >
              ...
              <div className="space-y-2">
                {profile.services.map((service) => (
                  ...
                  >
                    ...
                    <span className="font-semibold text-(--color-brand)">${service.min_hourly_rate}/hr</span>
                  </div>
                ))}
              </div>
            </div>

  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      <header className="mb-8">
        <p className="text-sm uppercase tracking-[0.18em] text-gray-500">Theta Legal</p>
      ...
      <section className="space-y-6 text-sm leading-6 text-gray-700">
        <p>
          These Referral Program Terms (&ldquo;Terms&rdquo;) govern participation in the Theta &ldquo;Give $20 / Get $20&rdquo; referral offer. They work together with our
        ...
        <article>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5">
            <li>Referrers must have an active Theta account in good standing.</li>
            <li>New students (the &ldquo;referee&rdquo;) must create a Theta account using the referrer&rsquo;s link and complete their first $75+ lesson within 30 days of signup.</li>
        ...
        <article>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5">
            <li>When the referee completes an eligible lesson, both the referrer and referee receive $20 in Theta credits.</li>
        ...
        <article>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5">
            ...
            <li>Credits have no cash value, are non-transferable, and may be used only on the Theta platform.</li>
        ...
        <article>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5">
            ...
            <li>Referral links may not be shared on coupon sites or paid ad networks without Theta&rsquo;s written consent.</li>
          </ul>
        </article>
        ...
        <article>
          ...
          <p className="mt-3">
            Theta may update or discontinue the referral program at any time. We will honor credits already issued unless the program ends due to abuse. Questions? Contact support@thetacoach.com.
          </p>
        </article>
      </section>
    </main>

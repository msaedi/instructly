    ...
    <div className="mx-auto w-full max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <section className="space-y-6 text-sm leading-6 text-gray-700 dark:text-gray-300">
        <p>
          ...
          <a href="/legal/terms" className="text-(--color-brand) underline"> Terms of Service</a> and
          <a href="/legal/privacy" className="text-(--color-brand) underline"> Privacy Notice</a>. By sharing a referral link or redeeming a referral reward, you agree to these Terms.
        </p>

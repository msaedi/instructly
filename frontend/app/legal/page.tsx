      ...
      <header className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 px-6 py-4 sticky top-0 z-40">
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          <Link href="/" className="inline-block">
            <h1 className="text-3xl font-bold text-(--color-brand) hover:text-[#5f1aa4] transition-colors cursor-pointer">
              {BRAND.name}
            </h1>
          </Link>
          <div className="flex items-center gap-4">
            {isAuthenticated ? (
              ...
              <Link
                href="/login"
                className="px-4 py-2 bg-(--color-brand) text-white rounded-lg hover:bg-[#5f1aa4] transition-colors font-medium"
              >
                Sign up / Log in
              </Link>
            )}
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        ...
                        isActive ? 'bg-(--color-brand)/10 text-[#4a1a85]' : 'hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300'
                      )}

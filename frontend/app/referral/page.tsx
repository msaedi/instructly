    ...
    <div className="relative overflow-hidden bg-gradient-to-b from-white via-purple-50 to-white">
      <div className="mx-auto flex min-h-[70vh] w-full max-w-5xl flex-col gap-16 px-4 py-16 sm:px-6 lg:flex-row lg:items-center lg:gap-20 lg:px-8">
        <section className="max-w-xl">
          <p className="mb-4 inline-flex items-center rounded-full bg-(--color-brand)/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.12em] text-(--color-brand)">
            Give $20 · Get $20
          </p>
          ...
          <div className="mt-10 flex flex-col items-start gap-3 sm:flex-row">
            <Link
              href="/signup"
              className="inline-flex items-center justify-center rounded-lg bg-(--color-brand) px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#6b1fb8] focus:outline-none "
            >
              Create an account
            </Link>
            <Link
          ...
          <p className="mt-8 text-xs text-gray-500 dark:text-gray-400">
            ...
            <Link href="/referrals-terms" className="text-(--color-brand) underline">
              Terms apply
            </Link>
            .
          </p>
        ...
        <section className="relative flex-1">
          <div className="mx-auto max-w-md rounded-3xl border border-purple-100 bg-white dark:bg-gray-800 p-8 shadow-xl">
            <p className="text-sm font-medium text-(--color-brand)">How it works</p>

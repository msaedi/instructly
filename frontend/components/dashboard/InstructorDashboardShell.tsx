  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        ...
        className="group relative inline-flex h-10 w-10 items-center justify-center rounded-full text-(--color-brand) transition-colors duration-150 focus:outline-none"
        title={label}
      >
        <Icon
        ...
        />
        {hasBadge ? (
          <span className="absolute -right-0.5 -top-0.5 inline-flex h-4 min-w-[16px] items-center justify-center rounded-full bg-(--color-brand) px-1 text-[10px] font-semibold leading-none text-white">
            {badgeLabel}
          </span>
        ) : null}
      </button>
      ...
      <header className="insta-dashboard-header px-4 py-4 sm:px-6">
        <div className="flex max-w-full items-center justify-between">
          <Link href="/instructor/dashboard" className="inline-block">
            <span className="cursor-pointer pl-0 text-3xl font-bold text-(--color-brand) transition-colors hover:text-purple-900 dark:hover:text-purple-300 sm:pl-4">
              iNSTAiNSTRU
            </span>
          </Link>
                      ...
                      <li key={item.key}>
                        <Link
                          ...
                          className={cn(
                            ...
                            isActive
                              ? 'border border-purple-200 bg-purple-50 font-semibold text-(--color-brand) dark:border-purple-700 dark:bg-purple-900/30 dark:text-purple-300'

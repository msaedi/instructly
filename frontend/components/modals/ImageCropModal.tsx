      ...
      footer={
        <div className="flex justify-end gap-3">
          ...
          <button
            type="button"
            onClick={handleSave}
            className="h-10 min-w-[112px] inline-flex items-center justify-center px-4 bg-(--color-brand) text-white rounded-md hover:bg-purple-800 dark:hover:bg-purple-700 cursor-pointer font-semibold"
          >
            Save
          </button>
        </div>
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-4">
          ...
          <input
            ...
            className="w-64 accent-(--color-brand)"
          />

      ...
      <form className="divide-y divide-gray-200">
        ...
        <div className="px-6 py-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {nycAreas.map((area) => (
              <label key={area} className="flex items-center space-x-2 cursor-pointer p-2 rounded-lg hover:bg-gray-50">
                <input
                  type="checkbox"
                  ...
                  <div>
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                      />
                      <span className="absolute right-3 top-1/2 transform -translate-y-1/2 text-sm text-gray-500">/hour</span>
                    </div>
                  </div>
                </div>
                <textarea

      ...
      {showActions && (
        <div className="absolute right-2 top-1/2 -translate-y-1/2 hidden group-hover:flex items-center gap-1 bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-1">
          <button
            ...
            className="inline-flex h-7 w-7 items-center justify-center rounded text-gray-500 dark:text-gray-400 transition-colors hover:bg-purple-50 dark:hover:bg-purple-900/30 hover:text-purple-900 dark:hover:text-purple-300"
          >

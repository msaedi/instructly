    ...
    <aside className="w-full lg:w-80 xl:w-96 border-b border-gray-200 dark:border-gray-700 lg:border-b-0 lg:border-r flex flex-col min-h-0 max-h-full overflow-hidden">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex items-center gap-2">
        ...
        <button
          ...
          className="inline-flex items-center justify-center rounded-full bg-purple-100 p-2 text-(--color-brand) transition-colors hover:bg-purple-200 dark:hover:bg-purple-800/40"
          ...
          return (
            <button
              ...
              className={`text-xs font-medium rounded-full px-2.5 py-1 transition-colors ${
                isActive ? 'bg-(--color-brand) text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-600'
              }`}
            >
              {option.label}
            </button>

      ...
      {!identityVerified ? (
        ...
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:gap-4">
          <Button
            ...
            className="w-full sm:w-auto rounded-lg sm:rounded-md text-base sm:text-sm h-auto sm:h-10 px-4 py-2 bg-(--color-brand) hover:bg-purple-800 dark:hover:bg-purple-700 text-white shadow-sm"
          >

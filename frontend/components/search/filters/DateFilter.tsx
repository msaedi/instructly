    ...
    >
      <div className="p-4">
        ...
        <input
          ...
          className="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg text-sm bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 placeholder:text-gray-500 focus:outline-none  focus:border-gray-300"
        />

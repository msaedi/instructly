    ...
    <div className="insta-dialog-backdrop z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="mt-5 flex justify-end gap-3">
          ...
          <button className={`rounded-md px-4 py-2 text-sm font-semibold text-white ${canSubmit ? 'bg-(--color-brand) hover:bg-purple-800 dark:hover:bg-purple-700' : 'bg-purple-300 cursor-not-allowed'}`} onClick={() => void submit()} disabled={!canSubmit}>

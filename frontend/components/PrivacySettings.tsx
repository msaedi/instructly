...
export function PrivacySettings({ className = '' }: PrivacySettingsProps) {
  ...
  return (
    <div className={`privacy-settings ${className}`}>
      ...
      <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900 dark:text-indigo-200 rounded-lg">
        <h4 className="text-sm font-medium text-blue-900 dark:text-indigo-200 mb-2">About Guest Sessions</h4>

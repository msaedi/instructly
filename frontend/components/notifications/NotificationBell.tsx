  ...
  return (
    <div ref={rootRef} className={cn('relative', className)}>
      <button
        ...
        title="Notifications"
        className="group relative inline-flex items-center justify-center h-10 w-10 rounded-full text-(--color-brand) transition-colors duration-150"
      >
        <Bell
          ...
          <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-700 px-3 py-2">
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="text-xs text-(--color-brand) hover:text-(--color-brand) disabled:opacity-60"
              >
                Mark all read
              </button>
            )}

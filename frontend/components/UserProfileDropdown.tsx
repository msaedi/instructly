  ...
  if (!user) {
    ...
    return (
      <button
        ...
        className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 px-4 py-2 text-sm font-medium"
      >
        Sign In
      </button>
    );
        ...
        >
          ...
          <div className={`${isMobileViewport ? 'py-1' : 'py-0.5'}`}>
                  ...
                  >
                    {instructorOnboardingComplete ? (
                      ...
                      <>
                        ...
                        <span className="text-(--color-brand) font-medium whitespace-nowrap">Finish Onboarding</span>
                      </>
                    )}
                  </button>
                )}
            ...
            <button
              ...
              className="w-full flex items-center gap-2 px-3 py-2 text-sm text-(--color-brand) hover:bg-purple-50 dark:hover:bg-purple-900/30 transition-colors"
            >

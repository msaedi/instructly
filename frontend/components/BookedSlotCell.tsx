    ...
    return (
      <button
        ...
        className="w-full h-full p-1 rounded bg-red-100 dark:bg-red-900 dark:text-red-200 border border-red-300
                   hover:bg-red-200 dark:hover:bg-red-800 active:bg-red-300 dark:active:bg-red-700 transition-colors cursor-pointer
      ...
      >
        {isFirstSlot ? (
          <>
            <span className="font-semibold text-[11px] text-red-800 dark:text-red-200">
              {slot.student_first_name} {slot.student_last_initial}
            </span>
            <span className="text-[10px] text-gray-600 dark:text-gray-400 flex items-center gap-0.5">
  ...
  return (
    <button
      ...
      className="w-full h-full p-2 rounded bg-red-100 dark:bg-red-900 dark:text-red-200 border border-red-300
                 hover:bg-red-200 dark:hover:bg-red-800 active:bg-red-300 dark:active:bg-red-700 transition-all cursor-pointer
                 flex flex-col justify-center items-center text-xs
    ...
    >
      {isFirstSlot ? (
        <div className="w-full space-y-1">
          ...
          <div className="text-gray-600 dark:text-gray-400 text-center flex items-center justify-center gap-1">

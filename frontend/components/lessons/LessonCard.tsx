        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-2xl sm:text-3xl font-bold text-(--color-brand)">
                {lesson.service_name}
              </h3>
          ...
          <button
            ...
            className="text-sm text-(--color-brand) hover:text-purple-900 dark:hover:text-purple-300 flex items-center gap-1 self-start sm:self-auto cursor-pointer font-medium"
          >
            See lesson details

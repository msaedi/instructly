    ...
    return (
      <div className={cn('relative', containerClassName)}>
        <input
          ...
          role="combobox"
          className={cn(
            'w-full rounded-md border border-gray-300 dark:border-gray-700 px-3 py-2 text-sm focus:outline-none focus:border-(--color-focus-brand)   disabled:cursor-not-allowed disabled:bg-gray-100 disabled:text-gray-500',
            inputClassName,
          )}
        />

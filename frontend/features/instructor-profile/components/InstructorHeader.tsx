            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <button
                    onClick={handleShare}
                    className="inline-flex items-center justify-center w-7 h-7 rounded-full hover:bg-purple-50 dark:hover:bg-purple-900/30 transition-transform cursor-pointer hover:scale-110"

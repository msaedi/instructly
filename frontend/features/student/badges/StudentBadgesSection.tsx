    ...
    <section aria-labelledby={headingId}>
      <div className="flex items-center justify-between mb-2">
        ...
        <button
          ...
          className="text-sm font-medium text-(--color-brand) hover:text-[#5b1898] transition-colors"
        >
          Explore
        </button>
      </div>
    ...
    >
      ...
      {hasProgress && progressPercent !== null && (
        <div className="mt-3" aria-label={`Progress ${progressPercent}%`}>
          ...
          >
            <div
              className="h-2 rounded-full bg-gradient-to-r from-(--color-brand) to-[#A855F7]"

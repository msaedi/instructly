...
Current approved production ignores: `13`
...
| [app/schemas/booking.py](/Users/mehdisaedi/instructly/backend/app/schemas/booking.py) | `assignment` | Pydantic response inheritance narrows `student` from private to instructor-safe public data. |

...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("non_travel_buffer_minutes", sa.Integer(), nullable=False, server_default="15"),
        sa.Column("travel_buffer_minutes", sa.Integer(), nullable=False, server_default="60"),
        sa.Column(
        ...
        sa.Column("calendar_settings_acknowledged_at", sa.DateTime(timezone=True), nullable=True),

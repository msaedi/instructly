...
def upgrade():
    ...
    op.create_index('idx_recurring_instructor_day', 'recurring_availability', ['instructor_id', 'day_of_week'])
    
    op.create_table('specific_date_availability',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('instructor_id', sa.Integer(), nullable=False),
    ...
    op.create_table('date_time_slots',
        sa.Column('id', sa.Integer(), nullable=False),

...
def upgrade() -> None:
    ...
    if not index_exists('idx_availability_slots_availability_id') and not index_exists('idx_availability_slots_availability'):
        op.create_index('idx_availability_slots_availability_id', 'availability_slots', ['availability_id'])
...
def downgrade() -> None:
    ...
    op.drop_index('idx_availability_slots_availability_id', table_name='availability_slots', if_exists=True)
    op.drop_index('idx_password_reset_tokens_user_id', table_name='password_reset_tokens', if_exists=True)

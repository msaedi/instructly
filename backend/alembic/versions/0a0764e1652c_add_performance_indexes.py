...
def upgrade():
    ...
    op.create_index('idx_recurring_availability_instructor_id', 'recurring_availability', ['instructor_id'])
    op.create_index('idx_recurring_availability_day', 'recurring_availability', ['instructor_id', 'day_of_week'])
    op.create_index('idx_specific_date_availability_instructor_date', 'specific_date_availability', ['instructor_id', 'date'])
    op.create_index('idx_date_time_slots_date_override_id', 'date_time_slots', ['date_override_id'])
    op.create_index('idx_blackout_dates_instructor_date', 'blackout_dates', ['instructor_id', 'date'])

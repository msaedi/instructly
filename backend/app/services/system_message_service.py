...
class SystemMessageService(BaseService):
    ...
    def create_booking_rescheduled_message(
        ...
        if old_date == new_date:
            ...
            content = f"🔄 Lesson rescheduled: {new_date_str}, {old_time_str} → {new_time_str}"
        else:
            content = f"🔄 Lesson rescheduled: {old_date_str} → {new_date_str} at {new_time_str}"
    ...
    def create_booking_completed_message(
        ...
        if service_name:
            content = f"✅ Lesson completed: {service_name}, {date_str}"
        else:
            content = f"✅ Lesson completed: {date_str}"

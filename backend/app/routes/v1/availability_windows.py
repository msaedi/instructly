# backend/app/routes/v1/availability_windows.py
"""
Availability management routes for InstaInstru (v1).

Migrated from /instructors/availability to /api/v1/instructors/availability

...
def _build_admin_instructor_detail_response(
    ...
    response_payload = {
        ...
        "verified_first_name": getattr(profile, "verified_first_name", None),
        "verified_last_name": getattr(profile, "verified_last_name", None),
        "verified_dob": getattr(profile, "verified_dob", None),
        "bgc_submitted_first_name": getattr(profile, "bgc_submitted_first_name", None),
        "bgc_submitted_last_name": getattr(profile, "bgc_submitted_last_name", None),

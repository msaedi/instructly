# backend/app/routes/v1/search_history.py
"""
Search History routes - API v1

Versioned search history endpoints under /api/v1/search-history.
...
Endpoints:
    ...
    POST /guest              → Record a guest search
    DELETE /{search_id}      → Delete a search
...
router = APIRouter(tags=["search-history-v1"])

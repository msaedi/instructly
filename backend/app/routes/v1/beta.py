# backend/app/routes/v1/beta.py
"""
Beta management routes for the InstaInstru platform (v1 API).

These routes provide access to beta invite management,
protected by admin role requirements.
"""

...
INSTRUCTOR_TEMPLATES = [
        ...
        "services": [
            {
                "skill": "Piano",
                "rate": 80,
                "desc": "Classical and jazz piano for all levels",
            },
            {
                "skill": "Music Theory",
                "rate": 70,
        ...
        "services": [
            {
                "skill": "Guitar",
                "rate": 75,
                "desc": "Electric and acoustic guitar lessons",
            },
            {
                "skill": "Bass Guitar",
                "rate": 75,
                "desc": "Bass guitar fundamentals and advanced techniques",
            },
        ],
    },
    {
        ...
        "services": [
            {
                "skill": "Math Tutoring",
                "rate": 90,
                "desc": "Algebra, Calculus, and Statistics",
            },
            {
                "skill": "SAT/ACT Prep",
                "rate": 100,
                "desc": "Comprehensive test preparation",
            },
        ],
    },
    {
        ...
        "services": [
            {
                ...
                "rate": 95,
                "desc": "From basics to advanced Python development",
            },
            {
    ...
    },
    {
        ...
        "services": [
            {
                "skill": "Chemistry Tutoring",
                "rate": 95,
                "desc": "General, Organic, and AP Chemistry",
            },
            {
                "skill": "Science Test Prep",
                "rate": 100,
                "desc": "AP and standardized test preparation",
            },
        ],
    },
]
...
def create_sample_bookings(session: Session):
    ...
    for instructor in instructors:
        ...
        slots_to_book = random.sample(
            ...
            min(
                len(available_slots),
                int(len(available_slots) * random.uniform(0.3, 0.5)),
            ),
        )

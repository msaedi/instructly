...
def test_booking_serialization():
    ...
    if booking:
        ...
        booking_dict = booking_response.model_dump() if hasattr(booking_response, 'model_dump') else booking_response.dict()
        ...
        json_str = booking_response.model_dump_json() if hasattr(booking_response, 'model_dump_json') else booking_response.json()
